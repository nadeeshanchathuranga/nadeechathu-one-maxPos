          ...
          <form @submit.prevent="submit">
            <div class="space-y-6">
              ...
              <div class="flex flex-col">
                ...
                <p v-if="form.errors.order_id" class="text-red-500 text-sm mt-1">{{ form.errors.order_id }}</p>
              </div>
                  ...
                  <tbody>
                    <tr v-for="(item, index) in filteredSaleItems" :key="item.id">
                      ...
                      <div class="pb-2">  {{ item.product.name }}</div>
                        <img  :src="item.product.image ? `/${item.product.image}` : '/images/placeholder.jpg'"  alt="Product Image" class="w-20 h-20 object-cover rounded-lg" />
                      </td>
              ...
              <div class="flex justify-center">
                <button class="px-8 py-2 text-2xl text-white bg-blue-600 rounded hover:bg-blue-700" type="submit">
                  Submit
                </button>
              </div>
            </div>
